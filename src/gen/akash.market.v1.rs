...
impl ::prost::Name for Reclamation {
    const NAME: &'static str = "Reclamation";
    const PACKAGE: &'static str = "akash.market.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "akash.market.v1.Reclamation".into()
    }
...
impl ::prost::Name for EventLeaseReclaimStarted {
    const NAME: &'static str = "EventLeaseReclaimStarted";
    const PACKAGE: &'static str = "akash.market.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "akash.market.v1.EventLeaseReclaimStarted".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/akash.market.v1.EventLeaseReclaimStarted".into()
    }
