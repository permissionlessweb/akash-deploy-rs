...
pub struct SendManifestRequest {
    ...
    pub manifest: ::prost::alloc::vec::Vec<
        super::super::super::manifest::v2beta3::Group,
    >,
}
...
impl ::prost::Name for AttestationQuoteRequest {
    const NAME: &'static str = "AttestationQuoteRequest";
    const PACKAGE: &'static str = "akash.provider.lease.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "akash.provider.lease.v1.AttestationQuoteRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/akash.provider.lease.v1.AttestationQuoteRequest".into()
    }
...
impl ::prost::Name for AttestationGpuReport {
    const NAME: &'static str = "AttestationGPUReport";
    const PACKAGE: &'static str = "akash.provider.lease.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "akash.provider.lease.v1.AttestationGPUReport".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/akash.provider.lease.v1.AttestationGPUReport".into()
    }
...
impl ::prost::Name for AttestationQuoteResponse {
    const NAME: &'static str = "AttestationQuoteResponse";
    const PACKAGE: &'static str = "akash.provider.lease.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "akash.provider.lease.v1.AttestationQuoteResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/akash.provider.lease.v1.AttestationQuoteResponse".into()
    }
