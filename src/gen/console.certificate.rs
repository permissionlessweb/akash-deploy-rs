...
impl ::prost::Name for CreateCertificateRequest {
    const NAME: &'static str = "CreateCertificateRequest";
    const PACKAGE: &'static str = "console.certificate";
    fn full_name() -> ::prost::alloc::string::String {
        "console.certificate.CreateCertificateRequest".into()
    }
...
pub struct CreateCertificateResponseData {
    #[prost(string, tag = "1")]
    pub cert_pem: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub pubkey_pem: ::prost::alloc::string::String,
    #[prost(string, tag = "3")]
    pub encrypted_key: ::prost::alloc::string::String,
}
impl ::prost::Name for CreateCertificateResponseData {
    const NAME: &'static str = "CreateCertificateResponseData";
    const PACKAGE: &'static str = "console.certificate";
    fn full_name() -> ::prost::alloc::string::String {
        "console.certificate.CreateCertificateResponseData".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/console.certificate.CreateCertificateResponseData".into()
    }
...
pub struct CreateCertificateResponse {
    ...
    pub data: ::core::option::Option<CreateCertificateResponseData>,
}
impl ::prost::Name for CreateCertificateResponse {
    const NAME: &'static str = "CreateCertificateResponse";
    const PACKAGE: &'static str = "console.certificate";
    fn full_name() -> ::prost::alloc::string::String {
        "console.certificate.CreateCertificateResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/console.certificate.CreateCertificateResponse".into()
    }
...
pub mod certificate_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn create_certificate(
            ...
            tonic::Response<super::CreateCertificateResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/console.certificate.CertificateService/CreateCertificate",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "console.certificate.CertificateService",
                        "CreateCertificate",
                    ),
                );
...
pub mod certificate_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/console.certificate.CertificateService/CreateCertificate" => {
                    ...
                    struct CreateCertificateSvc<T: CertificateService>(pub Arc<T>);
                    impl<
                        T: CertificateService,
                    > tonic::server::UnaryService<super::CreateCertificateRequest>
                    for CreateCertificateSvc<T> {
                        type Response = super::CreateCertificateResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as CertificateService>::create_certificate(
                                        &inner,
                                        request,
                                    )
                                    .await
    ...
    pub const SERVICE_NAME: &str = "console.certificate.CertificateService";
