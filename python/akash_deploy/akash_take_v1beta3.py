# Auto-generated from akash.take.v1beta3 — do not edit.
# Source: terp-rs/proto/src/gen/akash.take.v1beta3.rs
...
class DenomTakeRate:
    ...
    denom: str = ""
    rate: int = 0
    TYPE_URL: str = field(default="/akash.take.v1beta3.DenomTakeRate", init=False, repr=False)
...
class Params:
    ...
    TYPE_URL: str = field(default="/akash.take.v1beta3.Params", init=False, repr=False)
...
class GenesisState:
    ...
    TYPE_URL: str = field(default="/akash.take.v1beta3.GenesisState", init=False, repr=False)
