# Auto-generated from akash.wasm.v1 — do not edit.
# Source: terp-rs/proto/src/gen/akash.wasm.v1.rs
...
class Params:
    ...
    TYPE_URL: str = field(default="/akash.wasm.v1.Params", init=False, repr=False)
...
class MsgUpdateParams:
    ...
    authority: str = ""
    # params defines the x/wasm parameters to update.  NOTE: All parameters must be supplied.
    params: Optional[Params] = None
    TYPE_URL: str = field(default="/akash.wasm.v1.MsgUpdateParams", init=False, repr=False)
...
class MsgUpdateParamsResponse:
    ...
    TYPE_URL: str = field(default="/akash.wasm.v1.MsgUpdateParamsResponse", init=False, repr=False)
...
class QueryParamsRequest:
    ...
    TYPE_URL: str = field(default="/akash.wasm.v1.QueryParamsRequest", init=False, repr=False)
...
class QueryParamsResponse:
    ...
    params: Optional[Params] = None
    TYPE_URL: str = field(default="/akash.wasm.v1.QueryParamsResponse", init=False, repr=False)
...
@dataclass
class EventMsgBlocked:
    """EventMsgBlocked is triggered when smart contract does not pass message filter"""
    contract_address: str = ""
    msg_type: str = ""
    reason: str = ""
    TYPE_URL: str = field(default="/akash.wasm.v1.EventMsgBlocked", init=False, repr=False)
    ...
    @classmethod
    def decode(cls, data: bytes) -> "EventMsgBlocked":
        """Decode from protobuf binary (requires native extension)."""
        from akash_deploy._native import decode_message  # type: ignore[import]
        return cls(**json.loads(decode_message(cls.TYPE_URL, data)))
...
class GenesisState:
    ...
    params: Optional[Params] = None
    TYPE_URL: str = field(default="/akash.wasm.v1.GenesisState", init=False, repr=False)
