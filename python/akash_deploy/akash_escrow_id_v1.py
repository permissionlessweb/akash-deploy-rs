# Auto-generated from akash.escrow.id.v1 — do not edit.
# Source: terp-rs/proto/src/gen/akash.escrow.id.v1.rs
...
class Account:
    ...
    scope: int = 0
    xid: str = ""
    TYPE_URL: str = field(default="/akash.escrow.id.v1.Account", init=False, repr=False)
...
class Payment:
    ...
    aid: Optional[Account] = None
    xid: str = ""
    TYPE_URL: str = field(default="/akash.escrow.id.v1.Payment", init=False, repr=False)
